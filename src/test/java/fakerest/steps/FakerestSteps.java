...
public class FakerestSteps {
	...
	public void eu_valido_a_resposta_com_a_lista_completa_de_usuários() throws IOException {
	    fake.validateResponseCompleteUserList();
	}
	...
	public void eu_valido_a_imagem_de_capa_do_livro() throws IOException {
	    fake.validateResponseCoverPhoto();
	}
